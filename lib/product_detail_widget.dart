import 'package:badges/badges.dart'; // non-standard package to display number of items in cart
...
// display additional details for each product
        ...
        actions: [
          BlocBuilder<CartBloc, CartState>(builder: (_, cartState) {
            ...
            return Padding(
              ...
              child: Badge(
                // show number of items in cart in the badge
                badgeContent: Text(
                  '${cartItem.length}',
